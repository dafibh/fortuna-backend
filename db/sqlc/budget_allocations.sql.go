...
SELECT t.id, t.workspace_id, t.account_id, t.name, t.amount, t.type, t.transaction_date, t.is_paid, t.notes, t.created_at, t.updated_at, t.deleted_at, t.transfer_pair_id, t.category_id, t.is_cc_payment, t.cc_state, t.billed_at, t.settled_at, t.settlement_intent, t.source, t.template_id, t.is_projected, a.name AS account_name
FROM transactions t
